...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        if (userRepository.findAll().isEmpty()) {
            ...
            System.out.println();
            System.out.println();
            System.out.println("SSSSOSOSOSOSOSOSOSOOSOSS: " + userRepository.findAll().isEmpty());
            System.out.println();
            System.out.println();
            System.out.println();
            System.out.println();
...
//        saveUser(Role.USER, request);
    ...
    private void saveUser(Role role, RegisterRequest request) {
        var user = User.builder()
                .firstName(request.getFirstName())
                .lastName(request.getLastName())
                .email(request.getEmail())
